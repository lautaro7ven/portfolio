                ...
                <div class="row section-separator">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="mh-about-inner">
                            ...
                            <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">{{$aboutme->descripcion}}</p>
                            @endforeach
        ...
        <section class="mh-service">
            <div class="container">
                <div class="row section-separator">
                    ...
                    @foreach($users->aboutme as $about)
                    <div class="col-sm-4">
                        <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            ...
                            <h3>{{$about->technique}}</h3>
                            <p>
                               {{$about->techniquedescription}}
                            </p>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="row section-separator">
                        ...
                        <div class="col-sm-12">
                            <div class="mh-single-project-slide-by-side row">
                                @foreach($users->featuredproyects as $featured)
                                <!-- Project Items -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="mh-featured-project-content">
                                                ...
                                                <span class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">{{$featured->title}}</span>
                                                <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">{{$featured->description}}.</p>
